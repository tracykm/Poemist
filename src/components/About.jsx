...
const About = () => (
  <div className="about">
    ...
    <p>
      <i>
        A <strong>found poem</strong> is a poem that is composed
        with words and phrases from another text.
      </i>
    </p>
    <section>
      <p>
      ...
      <ul>
        <li>
          You will recieve exactly 40 lines of text
        </li>
        <li>
      ...
      <p>
        Direct any comments or questions to info@poemist.net.
      </p>
    </section>
  </div>
)
