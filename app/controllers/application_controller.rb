class ApplicationController < ActionController::Base
  ...
  def reset_guest_info(user)
    ...
    @style = Style.create(color_range:7);
    ...
    Like.create(poem_id: @poem.id, liker_id: 2, created_at:"2016-01-14T17:48:16.914Z")
    Like.create(poem_id: poem_id1, liker_id: 1)
    # Like.find_by(poem_id: 9, liker_id: 3).update(created_at:"2015-12-30T22:01:52.473Z", seen: true)
    # Like.find_by(poem_id: 37, liker_id: 2).update(created_at:"2016-01-14T17:48:16.914Z", seen: false)
    # Like.find_by(poem_id: 9, liker_id: 1).update(created_at: Time.now, seen: false)
